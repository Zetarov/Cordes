...
public class PlayerNotesGenerator : MonoBehaviour
{
    /*[SerializeField]
    ...
    public virtual void OnCaptureClosedContour(float time)
    {
    ...
    public virtual void SetIsCapturing(bool value)
    {
    ...
    public virtual void SetIsAttracting(bool value)
    {
